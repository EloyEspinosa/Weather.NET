...
namespace Weather.NET
{
    ...
    public static class CurrentHumidity
    {
        ...
        /// <summary>
        /// Gets the current humidity percentage in a given city asynchronously.
        /// More information in https://openweathermap.org/current#name
        /// </summary>
        /// <param name="name"> The name of the city. </param>
        /// <param name="apiKey"> The api key of the user. </param>
        ...
        /// <summary>
        /// Gets the current humidity percentage in a given location.
        ...
        /// <summary>
        /// Gets the current humidity percentage in a given location asynchronously.
        /// More information in https://openweathermap.org/current#geo
        /// </summary>
        /// <param name="latitude"> The latitude of the location. </param>
        /// <param name="longitude"> The longitude of the location. </param>
